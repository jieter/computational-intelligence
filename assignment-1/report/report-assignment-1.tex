...
\begin{document}
\maketitle
Onze groepssgenoot is om persoonlijke redenen gestopt met het vak. Deze opdracht hebben we met ons tweeën gemaakt.
...
\begin{enumerate}[1.]
	...
	\item De performance van dit netwerk is erg goed, en de training is ook erg snel klaar. Ook met 10 hidden neurons worden succes-percentages van boven de $90\%$ gehaald.
